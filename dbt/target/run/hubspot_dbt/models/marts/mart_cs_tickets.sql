  ...
  create view "warehouse"."marts_marts"."mart_cs_tickets__dbt_tmp"
...
with tickets as (
    select
        ...
        note_count,
        extracted_at
    from "warehouse"."marts_intermediate"."int_tickets_base"
),
...
ticket_contacts as (
    ...
    from "warehouse"."marts_staging"."stg_ticket_contacts"
),
...
contacts as (
    select
        ...
        became_customer_at,
        became_lead_at
    from "warehouse"."marts_intermediate"."int_contacts_base"
),
